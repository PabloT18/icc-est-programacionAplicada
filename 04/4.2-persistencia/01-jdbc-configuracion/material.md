...
Recupera el avance de [4.1](../../4.1-modelo-relacional/material.md). Conserva sus comandos y evidencias. Revisa el ejemplo completo antes de implementar la PC. Las demostraciones del material se ejecutan separadas del proyecto personal.
...
**Archivo completo:** [JdbcDemo.java](ejemplos/JdbcDemo.java).
...
**Dependencia compartida:** [Config.java](../../../demostraciones/src/main/java/edu/ups/pap/comun/Config.java). El archivo contiene la implementación completa y se compila junto con los ejemplos.
...
1. Migra CampusMonitor a Gradle Kotlin DSL conservando los paquetes y PCs anteriores. Incorpora el Wrapper y fija Java 25.
2. Implementa configuración YAML con sustitución explícita por variables de entorno y prueba una conexión PostgreSQL. No subas contraseñas.
3. Agrega un comando diagnostico-bd que consulte metadatos y ejecute SELECT 1. Diferencia error de configuración y SQLException.
